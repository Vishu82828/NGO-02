    ...
    <div className="home">
      <header className="hero">
        ...
        <div className="hero-content">
          ...
          <button className="cta-button" onClick={() => setShowDonation(true)}>Donate Now</button>
        </div>
      </header>
        ...
        {showDonation && (
          <div className="popup">
            <div className="popup-content">
              ...
              <h3>Donate Now</h3>
              <input type="number" placeholder="Enter amount" value={donationAmount} onChange={(e) => setDonationAmount(e.target.value)} />
      ...
      <section className="extra-content">
        ...
        <p>We are dedicated to making a difference in the community. Our team works on multiple social initiatives to uplift underprivileged groups.</p>
